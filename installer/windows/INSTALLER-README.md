# Relic Auditor 0.8.1 — Windows installer

`Relic-Auditor-Setup-0.8.1-x64.exe` installs the frozen Relic Auditor 0.8.1 release for the current Windows user.
...
```powershell
Get-FileHash ".\Relic-Auditor-Setup-0.8.1-x64.exe" -Algorithm SHA256
```
