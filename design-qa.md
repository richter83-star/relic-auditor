...
- Source visual truth:
  - `/workspace/scratch/192cb9f12f19/audit-evidence/relic-v102-corrected/01-opportunity-chooser.png`
  - `/workspace/scratch/192cb9f12f19/audit-evidence/relic-v102-corrected/02-contextual-technical-evidence.png`
- Rendered implementation:
  - `/workspace/scratch/192cb9f12f19/tmp/v103-qa/chooser-1920x1080.png`
  - `/workspace/scratch/192cb9f12f19/tmp/v103-qa/chooser-960x600.png`
  - `/workspace/scratch/192cb9f12f19/tmp/v103-qa/scoped-evidence-1920x1080.png`
...
- Full chooser: `/workspace/scratch/192cb9f12f19/tmp/v103-qa/comparisons/chooser-full.png`
- Focused chooser: `/workspace/scratch/192cb9f12f19/tmp/v103-qa/comparisons/chooser-focus.png`
- Full contextual evidence: `/workspace/scratch/192cb9f12f19/tmp/v103-qa/comparisons/evidence-full.png`

The focused comparison is required because row typography, selection state, density, preview placement, and primary-action count are too small to judge reliably in the full-window sheet.
...
- Post-fix evidence:
  - `/workspace/scratch/192cb9f12f19/tmp/v103-qa/chooser-1920x1080.png`
  - `/workspace/scratch/192cb9f12f19/tmp/v103-qa/chooser-960x600.png`
  - `/workspace/scratch/192cb9f12f19/tmp/v103-qa/comparisons/chooser-focus.png`
...
Qt render emitted no application warnings or errors. The Python suite completed with 443 tests passed and one environment-specific skip.
