# Relic Auditor 0.8.2 — Windows installer

`Relic-Auditor-Setup-0.8.2-x64.exe` installs the frozen Relic Auditor 0.8.2 release for the current Windows user.
...
```powershell
Get-FileHash ".\Relic-Auditor-Setup-0.8.2-x64.exe" -Algorithm SHA256
```
